		...
		<div class="mainbody">
			...
			<div class="home-mid-mainbody">
				...
				<div class="schedulecontent">
					...
					<div class="schedulecontent-left">
						<div class="schedulecontent-left-table">
							<table>
								<thead>
									<tr>
										<th>STT</th>
					...
					<div class="schedulecontent-right"></div>
				</div>
				<!-- InstanceEndEditable -->
			</div>
			<!-- Content-body: end-->
			...
			<div class="footer-bottom">
				...
				<div class="footer-bottom-menu">
					<ul>
						...
						<li class="active"><a href="schedule.html">LỊCH LÀM VIỆC</a></li>
					</ul>
				</div>
				<!-- InstanceEndEditable -->
			</div>
