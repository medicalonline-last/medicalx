	...
	<div class="main">
		...
		<div class="mainbody">
			...
			<div class="home-mid-mainbody">
        	  ...
        	  <div class="newspost-1">
        	    <div class="newpost-1-title"> <img src="images/medical-icon.png"/>
        	      <h4>Phòng chống dịch bệnh</h4>
      	      </div>
        	    <ul>
        	      <li><a href="">"Phòng Bệnh Tay Chân Miệng" Thông tin cần biết</a></li>
        	      <li><a href="">"Phòng Bệnh Sốt Xuất Huyết" Thông tin cần biết</a></li>
        	      <li><a href="">"Phòng chống bệnh Sởi" Thông tin cần biết</a></li>
        	      <li><a href="">Bệnh dại: Chia sẻ thông điệp - Cứu sống tính mạng</a></li>
        	      <li><a href="">Ghi nhận ổ dịch bệnh Ebola mới tại tỉnh Bắc Kivu, Cộng hòa dân chủ Công gô</a></li>
      	      </ul>
      	    </div>
        	  <div class="newspost-2">
        	    <div class="newpost-2-title"> <img src="images/medical-icon.png"/>
        	      <h4>Chủ trương mới của bệnh viện</h4>
      	      </div>
        	    <ul>
        	      <li><a href="">Lễ công bố quyết định thành lập khoa Cấp cứu, khoa Chấn thương chỉnh hỉnh và triển khai hoạt động của khoa Dinh dưỡng</a></li>
        	      <li><a href="">Thành lập đơn nguyên Ung Bướu bệnh viện đa khoa Đông Anh</a></li>
        	      <li><a href="">Hội nghị công bố và trao quyết định bổ nhiệm Phó Giám Đốc bệnh viện đa khoa Đông Anh</a></li>
        	      <li><a href="">Danh mục kĩ thuật được phê duyệt áp dụng tại bệnh viện đa khoa Đông Anh năm 2015, 2016, 2018</a></li>
        	      <li><a href="">Chương trình khám sức khỏe cho các đối tượng chính sách các xã trong huyện Đông Anh năm 2018</a></li>
      	      </ul>
      	    </div>
        	  <div class="newspost-3">
        	    <div class="newpost-3-title"> <img src="images/medical-icon.png"/>
        	      <h4>Y học trong nước</h4>
      	      </div>
        	    <ul>
        	      <li><a href="">Bệnh viện 71 Trung ương xây dựng đơn vị Y tế Xanh - Sạch - Đẹp</a></li>
        	      <li><a href="">Bộ Y tế thanh tra công tác y tế dự phòng và môi trường y tế tại Đắk Nông</a></li>
        	      <li><a href="">Xây dựng cơ sở y tế xanh, sạch, đẹp góp phần nâng cao sức khỏe cộng đồng</a></li>
        	      <li><a href="">Ngành Y tế Hà Nội: nhiều đơn vị tiên phong triển khai cơ sở y tế xanh, sạch, đẹp</a></li>
        	      <li><a href="">Công văn 407/TTMS-NVĐT ngày 12/12/2018 Của Trung tâm mua sắm tập trung thuốc quốc gia ký hợp đồng cung ứng thuốc ARV nguồn BHYT năm 2019</a></li>
      	      </ul>
      	    </div>
        	  <div class="newspost-4">
        	    <div class="newpost-4-title"> <img src="images/medical-icon.png"/>
        	      <h4>Y học quốc tế</h4>
      	      </div>
        	    <ul>
        	      <li><a href="">Phát hiện bất ngờ thủ phạm thực sự gây ra 800.000 ca ung thư mà không phải ai cũng biết?
Phát hiện bất ngờ thủ phạm thực sự gây ra 800.000 ca ung thư mà không phải ai cũng biết?</a></li>
        	      <li><a href="">Cùng các chuyên gia giải đáp thắc mắc về bệnh tăng huyết áp</a></li>
        	      <li><a href=""></a></li>
        	      <li><a href=""></a></li>
        	      <li><a href=""></a></li>
      	      </ul>
