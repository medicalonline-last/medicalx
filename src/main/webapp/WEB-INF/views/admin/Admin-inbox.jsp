                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul>
                                          <!-- InstanceBeginEditable name="thanhdieuhuong" -->
                                            <li class="list-inline-item seprate"> <span>/Hộp Thư Phản Hồi</span></li>
                                          <!-- InstanceEndEditable -->
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-comment-text"></i>Hòm Thư Phản Hồi</h3>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            ...
                                                            <div class="text">
                                                                ...
                                                                <p>Quên mật khẩu, xin cấp lại mật khẩu</p>
                                                            </div>
                                                        </div>
                                                        <div class="au-message__item-time">
                                                            <span>11:00 PM</span>
                                                ...
                                                <div class="au-message__item js-load-item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            ...
                                                            <div class="text">
                                                                <h5 class="name">Michelle Sims</h5>
                                                                <p>Thay đổi lịch hẹn với bác sĩ</p>
                                                            </div>
                                                        </div>
                                                        <div class="au-message__item-time">
                                                            <span>Yesterday</span>
