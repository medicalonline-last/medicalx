                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul>
                                          <!-- InstanceBeginEditable name="thanhdieuhuong" -->
                                            <li class="list-inline-item seprate"> <span>/Quản Lý Đơn Hàng</span></li>
                                          <!-- InstanceEndEditable -->
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Trang thái đơn hàng</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>100398</td>
                                                <td>Thuốc newcobex siro</td>
                                                <td class="text-right">VNĐ120.000</td>
                                                <td class="text-right">1</td>
                                                <td class="text-right">VNĐ120.000</td>
                                                <td class="process">Đang giao</td>
                                                <td>
