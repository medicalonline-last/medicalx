                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul>
                                          <!-- InstanceBeginEditable name="thanhdieuhuong" -->
                                            <li class="list-inline-item seprate"> <span>/Quản Lý Sản Phẩm</span></li>
                                          <!-- InstanceEndEditable -->
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3>${msg}</h3>
                                <h3 class="title-5 m-b-35">Dữ Liệu Sản Phẩm</h3>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="POST" action=addProduct.do>
                                                        ...
                                                        <div class="input-group image-preview">
                                                            ...
                                                            <span class="input-group-btn">
                                                                ...
                                                                <div class="btn btn-default image-preview-input">
                                                                    ...
                                                                    <span class="image-preview-input-title">Tìm</span>
