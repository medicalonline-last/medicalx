                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <div class="recent-report2">
                        <h3 class="title-3">Mức Độ Phản Hồi</h3>
                        <div class="chart-info">
                          <div class="chart-info__left">
                            <div class="chart-note"> <span class="dot dot--blue"></span> <span>Về Sản Phẩm</span></div>
                            <div class="chart-note"> <span class="dot dot--green"></span> <span>Về Hệ Thống</span></div>
                          </div>
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <div class="user-data m-b-40">
                        <h3 class="title-3 m-b-30"> <i class="zmdi zmdi-account-calendar"></i>Dữ Liệu Người Dùng</h3>
                            ...
                            <tbody>
                              <tr>
                                <td><div class="table-data__info">
                                  <h6>Phan Tuấn Anh</h6>
                                  <span> <a href="#">anhpt.hust@gmail.com</a></span></div></td>
                                <td><span class="role admin">Admin</span></td>
                                <td>Đầy đủ quyền hạn</td>
                                <td><span class="more"> <i class="zmdi zmdi-more"></i></span></td>
                              </tr>
                              <tr>
                                <td><div class="table-data__info">
                                  <h6>lori lynch</h6>
                                  <span> <a href="#">johndoe@gmail.com</a></span></div></td>
                                <td><span class="role user">Bệnh Nhân</span></td>
                                <td>Thực hiện các chức năng của bệnh nhân</td>
                                <td><span class="more"> <i class="zmdi zmdi-more"></i></span></td>
                              </tr>
                              <tr>
                                <td><div class="table-data__info">
                              ...
                              <tr>
                                <td><div class="table-data__info">
                                  <h6>lori lynch</h6>
                                  <span> <a href="#">johndoe@gmail.com</a></span></div></td>
                                <td><span class="role member">Bác Sĩ</span></td>
                                <td>Thực hiện các chức năng cho bác sĩ </td>
                                <td></td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div class="user-data__footer">
                          <button class="au-btn au-btn-load">Tải Thêm</button>
                        </div>
                      </div>
                      <!-- END USER DATA-->
                    </div>
